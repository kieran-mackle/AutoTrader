...
position size will be calculated based on trading account balance and the value assigned to `RISK_PC`.
...
parameters key, which will be tailored to your own strategy. 
