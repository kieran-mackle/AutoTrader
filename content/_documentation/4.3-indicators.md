...
Below is an example of this indicator, as detailed in the [Detecting Divergence](../) blog post. Note that this indicator
...
**See also**: [`find_swings`](#price-swing-detection), [`classify_swings`](#classifying-swings) and [`detect_divergence`](#detecting-divergence)
...
To detect 'higher highs' and 'lower lows'. This of course also detects 'lower highs' and 'higher lows'.
