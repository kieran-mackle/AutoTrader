...
by the `RR` key. As mentioned previously, this file is read by AutoTrader and passed into your strategy when it is instantiated. To make things
interesting, this tutorial will demonstrate a multi-instrument backtest, trading the 5 currency pairs defined in `WATCHLIST`.
