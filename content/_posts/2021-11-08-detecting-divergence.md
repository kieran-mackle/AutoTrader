...
the charts you see have been generated using using [AutoPlot](https://autotrader.readthedocs.io/en/latest/core/AutoPlot.html).
...
I have implemented in the [`find_swings`](https://autotrader.readthedocs.io/en/latest/indicators.html#swing-detection) utility indicator. This indicator
...
this, I make use of the [`candles_between_crosses`](https://autotrader.readthedocs.io/en/latest/indicators.html#candles-between-crosses) indicator. Finally, we can
...
[`unroll_signal_list`](https://autotrader.readthedocs.io/en/latest/indicators.html#unroll-signal-list). This can be used to take our 'Strong_lows' and 
...
[indicator library](https://autotrader.readthedocs.io/en/latest/indicators.html). You can find them under the following names:
- [`find_swings`](https://autotrader.readthedocs.io/en/latest/indicators.html#swing-detection)
- [`classify_swings`](https://autotrader.readthedocs.io/en/latest/indicators.html#classifying-swings) 
- [`detect_divergence`](https://autotrader.readthedocs.io/en/latest/indicators.html#detecting-divergence)

If you do not care about the intermediate steps, you can use the 
[`autodetect_divergence`](https://autotrader.readthedocs.io/en/latest/indicators.html#divergence) indicator, which is a wrapper for the indicators above.
