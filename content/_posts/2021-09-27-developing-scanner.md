...
scanner for trading with one of AutoTrader's [supported brokers](https://autotrader.readthedocs.io/en/latest/broker/broker-interface.html#supported-brokers-and-exchanges),
...
To build our trend notification indicator, we will rely on the [supertrend indicator](https://autotrader.readthedocs.io/en/latest/indicators.html#supertrend)
...
Head over to the [tutorials](https://autotrader.readthedocs.io/en/latest/tutorials/building-strategy.html) or [strategy documentation](https://autotrader.readthedocs.io/en/latest/userfiles/strategy.html) if you need 
...
[global configuration](https://autotrader.readthedocs.io/en/latest/userfiles/global-configuration.html) file. That way, you can use the same email address for 
...
indicators from the [AutoTrader library](https://autotrader.readthedocs.io/en/latest/indicators.html): candles_since_signal
