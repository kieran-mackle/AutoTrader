...
class AutoData:
    ...
    def _local_orderbook(self, dt: datetime, instrument: str = None, *args, **kwargs):
        ...
        if "midprice" in kwargs and kwargs["midprice"] is not None:
            ...
            # Load from OHLC data
            data = self._local(instrument=instrument, end_time=dt)
            # TODO - need to use correct timestamp!
